  ...
  return (
    <main className="flex-1 flex items-center justify-center min-h-screen bg-[#141414] text-white selection:bg-gamebees-accent-blue relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0 overflow-hidden">
        <div className="text-[18vw] font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white/[0.04] to-white/[0.002] leading-none select-none font-sans">
          SIGN UP
        </div>
      </div>
