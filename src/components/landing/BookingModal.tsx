          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 bg-[#10324D] border border-white/10 rounded-xl px-4 py-3">
                  <input
                    type="range"
                    min="3"
                    max="30"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-[#10324D] border border-white/10 pl-10 pr-4 py-3 text-sm text-white placeholder-white/30 focus:border-gamebees-accent-blue outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full rounded-xl bg-[#10324D] border border-white/10 pl-10 pr-4 py-3 text-sm text-white placeholder-white/30 focus:border-gamebees-accent-blue outline-none resize-none"
                  />
                </div>
              </div>
            </div>
